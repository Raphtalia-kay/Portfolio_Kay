      ...
      <section className="h-[1200px] bg-black px-32 text-white">
        ...
        <div className="lower-part flex flex-col gap-[30px] pt-[40px]">
          <div className="flex px-[40px]">
            <div className="project-image-side flex-[2] relative">
            ...
            <div className="project-detail-side relative flex-1 pt-[40px]">
              ...
              <div className="absolute right-0 top-[150px] w-[500px] rounded-md bg-gray-500 bg-opacity-10 px-[22px] py-[10px] shadow-inner backdrop-blur-sm transition-all duration-500">
          ...
          <div className="flex flex-row-reverse px-[40px]">
            ...
            <div className="project-detail-side relative flex-1 pt-[40px]">
              ...
              <div className="absolute left-0 top-[150px] w-[500px] rounded-md bg-gray-500 bg-opacity-10 px-[22px] py-[10px] shadow-inner backdrop-blur-sm transition-all duration-500">
                <p className="text-[14px]">
                  A minimal, dark blue theme for VS Code, Sublime Text, Atom,
                  iTerm, and more. Available on Visual Studio Marketplace,
                  Package Control, Atom Package Manager, and npm.
