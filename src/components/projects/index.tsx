    ...
    <>
      <section className="h-[800px] bg-black px-28 text-white">
        ...
        <div className="flex flex-wrap justify-center gap-[20px] pt-[20px]">
          <div className="flex h-[150px] w-[600px] items-center overflow-hidden rounded-lg px-[12px] py-[6px] transition-all hover:bg-gray-400 hover:!bg-opacity-10 hover:shadow-inner hover:backdrop-blur-sm">
